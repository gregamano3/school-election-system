...
export const electionAllowedGroups = schema.electionAllowedGroups;
export const users = schema.users;
export const votes = schema.votes;
export const auditLog = schema.auditLog;
export const siteSettings = schema.siteSettings;

export type Group = pgSchema.Group;
export type UserGroup = pgSchema.UserGroup;
export type ElectionAllowedGroup = pgSchema.ElectionAllowedGroup;
...
export type NewGroup = pgSchema.NewGroup;
export type NewUserGroup = pgSchema.NewUserGroup;
export type NewElectionAllowedGroup = pgSchema.NewElectionAllowedGroup;